...
class MyTestCase(unittest.TestCase):
    ...
    #     attn = indexing(attn_block, query_sort_idx_inv)+attn_sample
    #     lse_block = indexing(lse_block, query_sort_idx_inv).squeeze(-1)
    #     lse = (lse_sample.exp() + lse_block.exp()).log().to(dtype=lse_block.dtype)
    #     t1 = time.time()
    #     check_memory()
    #     print(lse[0, 0])
    #     print('the runtime of torch permutation and indexing of queries:', t1-t0)
    #
    ...
    #     check_memory()
    #     t3 = time.time()
    #     print('the runtime of triton permuting queries:', t3 - t2)
    #
    #     print(lse_triton[0, 0])
    #     print((lse - lse_triton).norm(), lse.norm())
    #
    #     print('error blocked flash attention:', (lse_triton - lse_torch).norm(), lse_torch.norm())
    #
    ...
    #     # assert torch.equal(lse_permute, lse)
    #     # assert torch.equal(attn_permute, attn)
